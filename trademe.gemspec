Gem::Specification.new do |s|
  ...
  s.files = %w[
    ...
    init.rb
    lib/trademe.rb
    lib/trademe/gateway/authentication.rb
    lib/trademe/gateway.rb
    lib/trademe/gateway/my_trademe.rb
    lib/trademe/loggers.rb
    lib/trademe/loggers/file_logger.rb
    lib/trademe/loggers/multiple_logger.rb
    lib/trademe/loggers/redis_count_logger.rb
